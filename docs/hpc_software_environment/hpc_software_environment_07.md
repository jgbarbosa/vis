...
setenv("TACC_TOPHAT_DIR", "/work/0003/train332/stampede2/apps/tophat/2.1.1")
prepend_path("PATH",      "/work/0003/train332/stampede2/apps/tophat/2.1.1/bin")
...
$ pwd
/work/0003/train332/stampede2/apps/modulefiles
$ echo $PWD
/work/0003/train332/stampede2/apps/modulefiles
$ module use $PWD
$ echo $MODULEPATH
